...
import { 
  ...
  signInWithPopup,      // IMPORTANTE: Para o popup do Google
  GoogleAuthProvider,   // IMPORTANTE: Provedor do Google
  signOut,
  onAuthStateChanged 
} from 'firebase/auth';
import { 
...
// --- TELA DE LOGIN ---
const LoginScreen = ({ onLogin, onRegister, onResetPassword, onGoogleLogin, error }) => {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 w-full" style={{ colorScheme: 'light' }}>
      <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full border border-slate-100">
        ...
        <button 
            ...
            className="w-full bg-white text-slate-700 border border-slate-300 font-bold py-2.5 rounded-lg hover:bg-slate-50 transition-colors shadow-sm flex items-center justify-center gap-2"
        >
